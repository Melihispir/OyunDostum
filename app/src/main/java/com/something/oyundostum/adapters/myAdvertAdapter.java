...
public class myAdvertAdapter extends RecyclerView.Adapter<myAdvertAdapter.MyViewHolder> implements Filterable {
    ...
    public myAdvertAdapter(Context context, ArrayList<ilanlar_veriler> products, CustomItemClickListener Listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.myadvert_item_cardview, parent, false);
